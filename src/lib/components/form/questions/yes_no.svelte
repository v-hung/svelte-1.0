    ...
    <div class="flex -mx-2 flex-wrap">
      <div class="w-1/3 px-2 mb-4">
        <input 
          ...
          id="passage[{passage_index}]group[{group_index}]question_answer[{index}]yes" 
          value="yes" 
          class="sr-only"
        >
        <label class="item-answer" for="passage[{passage_index}]group[{group_index}]question_answer[{index}]yes" >
      ...
      <div class="w-1/3 px-2 mb-4">
        <input 
          type="radio" 
          name="passage[{passage_index}]group[{group_index}]question_answer[{index}]" 
          id="passage[{passage_index}]group[{group_index}]question_answer[{index}]no" 
          value="no" 
          class="sr-only"
        >
        <label class="item-answer" for="passage[{passage_index}]group[{group_index}]question_answer[{index}]no" >
