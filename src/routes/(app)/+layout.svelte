...
<div class="sticky px-8 shadow-xl bg-white">
...
<style lang="postcss">
  .nav-link {
    @apply relative h-full inline-flex items-center border-b-2 border-transparent hover:border-b-orange-600 text-primary font-semibold cursor-pointer;
  }
  ...
  .dropdown .text {
    @apply h-full flex items-center border-b-2 border-transparent hover:border-b-orange-600 text-primary font-semibold space-x-1 cursor-pointer;
  }
  .dropdown::before {
    content: '';
