      ...
      <div class="left-sidebar flex-none h-screen shadow relative z-10 {collapse ? 'sidebar-collapse' : ''}" style="width: {collapse ? '60px' : '200px'}">
        <div class="fixed w-[inherit] h-full flex flex-col bg-white">
          ...
          <div class="flex-grow min-h-0 flex flex-col space-y-2 px-3 py-4 text-sm overflow-y-auto">
            ...
            <a href="/admin" class="link {pathname == "" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/products" class="link {pathname == "products" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/categories" class="link {pathname == "categories" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/quizzes" class="link {pathname == "quizzes" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/user" class="link {pathname == "user" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/role" class="link {pathname == "role" ? "active" : ''}">
              <span class="icon">
            ...
            <a href="/admin/settings" class="link {pathname == "settings" ? "active" : ''}">
              <span class="icon">
              ...
              {#if toggle_user}
                <div transition:slide={{ duration: 300 }} class="absolute top-full right-0 z-10">
                  <div class="w-40 flex flex-col space-y-2 mt-1 p-3 bg-white shadow text-sm rounded">
                    <a href="/admin/user" class="link bg-orange-100 text-orange-700 hover:!bg-orange-200">
                      <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M7.5 6.5C7.5 8.981 9.519 11 12 11s4.5-2.019 4.5-4.5S14.481 2 12 2 7.5 4.019 7.5 6.5zM20 21h1v-1c0-3.859-3.141-7-7-7h-4c-3.86 0-7 3.141-7 7v1h17z"></path></svg>
                      </span>
                      <span>User</span>
...
<style lang="postcss">
  ...
  :global(#admin h1, #admin h2, #admin h3, #admin h4, #admin h5) {
    @apply text-[#333];
  }
  .left-sidebar{
  }
